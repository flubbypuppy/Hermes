...
var isHotkeyMatchingKeyboardEvent = function isHotkeyMatchingKeyboardEvent2(e, hotkey, pressedDownKeys) {
...
var HotkeysProvider = function HotkeysProvider2(_ref) {
  ...
  var isAllActive = (0, import_react.useMemo)(function() {
    return internalActiveScopes.includes("*");
  }, [internalActiveScopes]);
  var enableScope2 = function enableScope3(scope) {
    if (isAllActive) {
  ...
  var disableScope2 = function disableScope3(scope) {
  ...
  var toggleScope2 = function toggleScope3(scope) {
  ...
  var addBoundHotkey = function addBoundHotkey2(hotkey) {
    setBoundHotkeys([].concat(boundHotkeys, [hotkey]));
  };
  var removeBoundHotkey = function removeBoundHotkey2(hotkey) {
...
function useHotkeys(keys, callback, options, dependencies) {
  ...
  var _useRef = (0, import_react.useRef)(/* @__PURE__ */ new Set()), pressedDownKeys = _useRef.current;
  ...
  var cb = (0, import_react.useCallback)(callback, [].concat(_deps));
